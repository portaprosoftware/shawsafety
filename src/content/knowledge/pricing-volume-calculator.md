...
questions:
  ...
  - 'How do I see which tier I land in?'
keywords:
  - 'calculator'
  - 'order total'
  - 'savings'
...
The wholesale page (/wholesale) carries a volume calculator. Pick a product and
a color, enter a quantity in packs, and it reports the tier that quantity lands
in, the price per pack, the total units (ties or vests), the order total, and
