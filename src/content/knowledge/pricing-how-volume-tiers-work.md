...
questions:
  ...
  - 'Do I need an account to get wholesale pricing?'
  - 'Is there a minimum order?'
  - 'Do I have to negotiate for a discount?'
keywords:
  - 'volume discount'
  - 'price ladder'
  - 'automatic discount'
...
prices may change at any time, but the price confirmed at checkout governs that
order.
