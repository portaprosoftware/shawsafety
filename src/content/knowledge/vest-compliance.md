...
questions:
  ...
  - 'What is Type R?'
  - 'Are the vests rated for roadway work?'
keywords:
  - 'ANSI/ISEA 107-2020'
  - 'Type R'
  - 'OSHA 1926.201'
...
The hi-vis vest carries three published compliance marks: **ANSI/ISEA 107-2020
...
headlights. The 5-point breakaway releases at both shoulders, both sides, and
the front closure if the vest catches on moving equipment. And the vests ship
in crew-sized 10-packs so a yard can outfit a shift in one line item, with
mixed sizing available on bulk orders.
