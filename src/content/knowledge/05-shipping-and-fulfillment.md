...
topic: 'shipping'
url: '/contact#shipping'
sourceLabel: 'Shipping & Returns'
chunkBy: 'section'
questions:
  - 'When will my order ship?'
  - 'How long does delivery take to my state?'
  - 'Is shipping free?'
...
Dispatch is subject to stock availability.
...
- **1 day:** Ohio, Pennsylvania, Indiana, Michigan, Kentucky, West Virginia,
  Virginia, New York.
- **2 days:** Illinois, Wisconsin, Minnesota, Iowa, Missouri, Tennessee, North
  Carolina, South Carolina, Georgia, Alabama, Vermont, New Hampshire, Maine,
  Massachusetts, Rhode Island, Connecticut, New Jersey, Maryland, Delaware.
- **3 days:** North Dakota, South Dakota, Nebraska, Kansas, Oklahoma, Texas,
  Louisiana, Arkansas, Mississippi, Florida, Wyoming, Colorado, Utah, Montana.
- **4 days:** California, Nevada, Arizona, New Mexico.
- **5 days:** Washington, Oregon, Idaho, Alaska, Hawaii.

Transit times are carrier estimates. If a delivery date matters (job start,
terminal audit, quarterly rollout), contact sales for a guaranteed delivery
...
Standard ground shipments go via a national parcel carrier selected daily based
on transit performance and rate to the destination ZIP. For LTL-sized orders
(typically 500+ packs to a single address), an LTL carrier is dispatched with a
pallet shipment; a phone number for delivery scheduling is required.
...
PO Box shipping is available for retail-sized orders (typically under 20 packs)
via a carrier that services PO boxes. For orders larger than one small parcel, a
physical street address is required. Residential deliveries are handled the
same as commercial deliveries, though transit times to remote residential ZIPs
may add one business day.

## Order tracking

Tracking numbers are emailed to the address used at checkout the moment the
label is generated, typically the morning of the ship day. If a tracking email
does not arrive within one business day of order confirmation, check the spam
folder first and then contact support with the order number.

## Delivery signature

Signature is not required by default. For high-value orders, or for a buyer who
wants to require signature on delivery, request the change at checkout in the
order notes or contact sales before the ship cutoff.

## Damaged or lost shipments

If a package arrives visibly damaged, note the damage with the carrier at
delivery and photograph the outer box and the affected ties. Contact support
within 5 business days of delivery with the order number and photos, and Shaw
...
Standard stock is not typically backordered because the four SKUs are produced
against a running forecast. In the rare event a color is temporarily out of
stock, the product page will display the estimated back-in-stock date and
orders placed against the backorder ship free by expedited service once
inventory clears. If timing is critical, choose an in-stock color and use color
assignment on the receiving end instead.
...
For customer-arranged pickups destined for Canada or Mexico, duties, taxes, and
brokerage are the buyer's responsibility and are not included in the invoice
from Shaw Safety.
